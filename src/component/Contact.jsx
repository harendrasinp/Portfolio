        ...
        <div className={ContactStyle.form}>
          <form>
            <div class="grid gap-6 mb-6 md:grid-cols-2">
              <div>
                <label for="first_name" class="block mb-1 text-[15px]  font-medium md:text-orange-400 dark:text-white">First name</label>
              ...
              <div>
                <label for="phone" class="block mb-1 text-[15px] font-medium md:text-orange-400 dark:text-white">Phone number</label>
            ...
            <div class="grid gap-6 mb-6 md:grid-cols-2">
              <div>
                <label for="email" class="block mb-1 text-[15px] font-medium md:text-orange-400 dark:text-white">Your Email</label>
              ...
              <div>
                <label for="city" class="block mb-1 text-[15px] font-medium md:text-orange-400 dark:text-white">City</label>
            ...
            <label for="message" class="block mb-1 text-[15px] font-medium md:text-orange-400 dark:text-white">Your message</label>
